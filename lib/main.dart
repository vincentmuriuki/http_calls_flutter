...
class HttpCallsMain extends StatelessWidget {
...
class RealWorldState extends State<StatefulWidget> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      title: "Http Calls Flutter",
      home: new Scaffold(
          appBar: new AppBar(
            title: new Text("Http Calls Flutter"),
            actions: <Widget>[
              new IconButton(
                icon: new Icon(Icons.refresh),
                color: Colors.white,
